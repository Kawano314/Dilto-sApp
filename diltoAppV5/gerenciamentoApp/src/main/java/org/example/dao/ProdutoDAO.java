...
public class ProdutoDAO {
    ...
    public Produto inserir(Produto produto) throws SQLException {
        String sql = """
            INSERT INTO produtos (nome, codigo, descricao, preco, quantidade_estoque, 
        ...
        try (PreparedStatement pstmt = connectDB.getConnection().prepareStatement(sql,
            ...
            pstmt.setDouble(4, produto.getPreco().doubleValue());
            pstmt.setInt(5, produto.getQuantidadeEstoque());
            pstmt.setString(6, produto.getCategoria());
            pstmt.setString(7, produto.getDataCadastro().toString());
            pstmt.setString(8, produto.getDataAtualizacao().toString());
    ...
    public boolean atualizarEstoque(Long id, int quantidade) throws SQLException {
        String sql = """
            UPDATE produtos 
            SET quantidade_estoque = quantidade_estoque + ?, data_atualizacao = ?
            WHERE id = ?
        """;
